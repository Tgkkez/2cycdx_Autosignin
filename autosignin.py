...
Name: 2cycdx自动签到 
Author: Tgkkez
Author URI: https://github.com/Tgkkez/2cycdx_Autosignin
Version: 1.0.1
更新记录：更新网站域名
License: GNU General Public License v3.0
License URI: https://www.gnu.org/licenses/gpl-3.0.html
description:
论坛官网：https://www.2cycdx.com/
每天签到领贡献～

使用浏览器登录之后, F12-网络-文档，刷新一下网页，点击www.2cycdx.com，把请求里面的Cookie的值填到环境变量变量cycd_cookie里, 多账号换行或&或@隔开
...
def get_formhash(cookie):
  url_hash = "https://www.2cycdx.com/plugin.php?id=dc_signin"
  headers_hash = {
    "Accept": "*/*",
    ...
    "Referer": "https://www.2cycdx.com/plugin.php?id=dc_signin",
...
def sign_in(cookie, formhash_value):
  url_sign = "https://www.2cycdx.com/plugin.php?id=dc_signin:sign&inajax=1"
  headers_sign = {
    "Host": "www.2cycdx.com",
